...
class AppointmentEvent with _$AppointmentEvent {
  ...
  const factory AppointmentEvent.deleteAppointment({required int? appointmentId}) = DeleteAppointment;
  const factory AppointmentEvent.updateAppointment({
    required int appointmentId,
    required Map<String, dynamic> updatedFields,
  }) = UpdateAppointment;

  const factory AppointmentEvent.addAppointment({required AppointmentModel appointmentData}) = AddAppointment;
}
